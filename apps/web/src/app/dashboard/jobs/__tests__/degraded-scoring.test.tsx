...
describe("Job Discovery — 10-Dimensional Fit Score grid degraded-scoring UI (GMV4-ats-001/002)", () => {
  ...
  it("does not plot the placeholder in the radar chart when a dimension is degraded", async () => {
    ...
    const shape1 = svg1.querySelector('polygon[stroke="#AE8E32"]')!.getAttribute("points");
    cleanup();
    ...
    const shape2 = svg2.querySelector('polygon[stroke="#AE8E32"]')!.getAttribute("points");
    ...
    const shape3 = svg3.querySelector('polygon[stroke="#AE8E32"]')!.getAttribute("points");
    cleanup();
    ...
    const shape4 = svg4.querySelector('polygon[stroke="#AE8E32"]')!.getAttribute("points");
