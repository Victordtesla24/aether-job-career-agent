    ...
    >
      ...
      <div className="mb-2.5 grid grid-cols-2 gap-2.5">
        <button
          ...
          aria-expanded={open}
          className="flex min-h-[44px] items-center justify-center gap-2 rounded-xl border border-hairline bg-white/5 py-2.5 text-xs font-medium transition hover:bg-white/10 disabled:opacity-50"
        >
          <i className="fa-solid fa-comment-dots text-[11px] text-state-info" aria-hidden="true" />
          Request Changes
        </button>
        <button
          type="button"
        ...
        >
          <i
            className={
              exporting
                ? "fa-solid fa-circle-notch fa-spin text-[11px] text-state-info"
                : "fa-solid fa-file-arrow-down text-[11px] text-state-info"
            }
            aria-hidden="true"
          />
      ...
      {open ? (
        <form
          className="mb-2.5 rounded-xl border border-hairline bg-white/5 p-3"
        ...
        >
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-hairline bg-transparent px-3 py-2 text-xs text-white placeholder:text-aether-muted-dim focus:border-aether-coral/50 focus:outline-none"
          ...
          <button
            ...
            className="mt-2 flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-state-info/20 py-2 text-xs font-semibold text-state-info transition hover:bg-state-info/30 disabled:opacity-50"
          >
            {refining ? (
              <>
      ...
      <Link
        ...
        className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-xl border border-aether-indigo/25 bg-aether-indigo/15 py-2.5 text-xs font-medium text-state-info transition hover:bg-aether-indigo/25"
      >
