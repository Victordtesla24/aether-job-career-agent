...
Re-run of the full headless audit after the W-E fix waves (deploy = wave-2 commit): **0 console errors, 0 axe serious/critical violations, 0 unnamed controls, no 360 px horizontal scroll, 0 failed requests.** Residual 'us-date' hit is a detector false-positive on the en-AU string 01/08/2026.
